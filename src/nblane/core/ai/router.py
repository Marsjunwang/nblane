    ...
    "research.paper_deep_read_codex": AIActionSpec(
        ...
        schema=schema_for_keys(
            ...
            properties={
                ...
                "problem": {"type": ["array", "object", "string"]},
                "motivation": {"type": ["array", "object", "string"]},
                "context": {"type": ["array", "object", "string"]},
                "contributions": {"type": "array"},
                "method": {"type": "array"},
                ...
                "results": {"type": "array"},
                "limitations": {"type": "array"},
                "project_relevance": {"type": ["array", "object", "string"]},
                "open_questions": {"type": "array"},
                "section_summaries": {"type": "array"},
                "terms": {"type": "array"},
                "batch_reading": {"type": "object"},
