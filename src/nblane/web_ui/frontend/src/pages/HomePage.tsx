...
import { useStarmapData } from '../starmap/useStarmapData';
 ...
 * GET /api/v1/profiles/{name}/starmap; see src/starmap/useStarmapData.ts.
 */
export function HomePage() {
  const { name = '' } = useParams();
  const { snapshot, isPending, isError, error } = useStarmapData(name);
