...
_RESEARCH: dict[str, dict[str, str]] = {
    "en": {
        ...
        "ai_config": "AI Config",
        "ai_config_caption": (
            "These preferences are saved to the active profile and only override paper reading AI actions."
        ),
    ...
    "zh": {
        "page_title": "Research · nblane",
        "title": "研究工作台 Research",
        "page_context_line": "外部资料先沉淀为 source-aware claim / citation；审阅后再进入 evidence 或公开输出。",
        "source_inbox": "来源收件箱 Source Inbox",
        "reading_room": "阅读室 Reading Room",
        "claims_citations": "断言与引用 Claims",
        "synthesis_drafts": "综合草稿 Synthesis",
        "connectors": "连接器 Connectors",
        "ai_config": "AI配置",
        "ai_config_caption": "这些偏好会保存到当前 profile，只覆盖论文阅读里的 AI 动作。",
        ...
        "ready_claims": "Ready claims",
        "drafts_total": "草稿 Drafts",
        "connectors_enabled": "启用 connectors",
        ...
        "create_research_claim": "创建 research claim",
        "research_claim_id": "Research claim id",
        "research_claim_type": "Claim 类型",
        "research_claim_status": "Claim 状态",
        "research_claim_text": "Claim 文本",
        "research_claims": "Research claims",
        "claims_empty": "暂无 research claim。",
        "human_note": "无 source/chunk 的人工备注",
        "rationale": "理由",
        "create_citation": "创建 citation",
        "citation_quote": "引用摘录",
        "bibliography": "Bibliography",
        "research_citations": "Research citations",
        "citations_empty": "暂无 citation。",
        "create_synthesis_draft": "创建 synthesis draft",
        "synthesis_draft_id": "Synthesis draft id",
        "drafts_empty": "暂无 synthesis draft。",
        "blog_candidate_preview": "Blog candidate 预览",
        "create_blog_draft": "创建博客草稿",
        "body": "正文",
        "connectors_caption": "Connector 配置不保存 token、cookie 或 API key。",
        "connectors_empty": "暂无 connector 配置。",
