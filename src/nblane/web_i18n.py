...
_HOME: dict[str, dict[str, str]] = {
    "en": {
        ...
        "dashboard_metric_skill_lit": "Skill lit",
        ...
        "dashboard_health_title": "Profile Health",
        ...
        "dashboard_yes": "Yes",
        "dashboard_no": "No",
        "dashboard_output_title": "Output opportunities",
        ...
        "dashboard_quick_title": "Quick entries",
        "dashboard_overview_map_title": "Map of now",
        "dashboard_graph_eyebrow": "Canvas",
        "dashboard_graph_title": "Goal to evidence map",
        ...
        "dashboard_inspector_placeholder_hint": "This object is reserved in the Growth Graph P0 skeleton.",
        "dashboard_inspector_locked_hint": "Private or locked details are hidden in this view.",
        "dashboard_inspector_owner_reserved": "Interface reserved",
        ...
        "dashboard_feedback_planned": "Feedback interface reserved.",
        ...
        "dashboard_node_capacity": "North Star 容量",
    ...
    "zh": {
        ...
        "dashboard_health_title": "Profile Health 摘要",
        ...
        "dashboard_quick_title": "快捷入口",
        "dashboard_overview_map_title": "当前地图",
        "dashboard_graph_eyebrow": "Canvas",
        "dashboard_graph_title": "目标到证据地图",
        "dashboard_graph_goal_missing": "设置 current goal",
        "dashboard_graph_blocked": "阻塞",
        "dashboard_evidence_inbox_title": "Evidence inbox",
        "dashboard_open_section": "打开",
        "dashboard_goal_create_inline": "创建 goal",
        "dashboard_goal_edit_inline": "编辑 goal",
        "dashboard_goal_close_form": "收起",
        "dashboard_goal_advanced_fields": "高级 goal 字段",
        ...
        "dashboard_inspector_placeholder_hint": "该对象已在 Growth Graph P0 骨架中预留接口。",
        "dashboard_inspector_locked_hint": "该节点的私密或锁定细节已在当前视图隐藏。",
        "dashboard_inspector_owner_reserved": "接口已保留",
        "dashboard_placeholder_metric": "planned",
        ...
        "dashboard_atomic_evidence_title": "Atomic evidence",
        "dashboard_evidence_candidate_title": "Evidence candidates",
        "dashboard_atomic_evidence_unlinked": "未挂技能的 atomic rows",
        "dashboard_gap_risk_title": "Gap risk",
        "dashboard_feedback_planned": "Feedback 接口已预留。",
        "dashboard_graph_loading": "正在加载图谱…",
        "dashboard_graph_3d_hint": (
            "North Star 依次流向 goals、项目容器、活动、来源、证据、断言、能力、输出、反馈与治理。"
            "可旋转、缩放；点击节点后在右侧查看。"
        ),
        "dashboard_view_canvas": "Canvas",
        "dashboard_view_3d_graph": "3D Graph",
        ...
        "dashboard_layer_objective": "阶段目标",
        "dashboard_layer_work_context": "项目容器",
        "dashboard_layer_activity": "执行活动",
        ...
        "dashboard_set_as_primary": "设为 primary",
        "dashboard_set_primary": "设为 primary",
