    ...
    *,
    ...
    if component_func is not None:
        result: Any = component_func(
            ...
            translation_summary=dict(translation_summary or {}),
            translation_revision=translation_revision or "",
            compare_split_ratio=compare_split_ratio if compare_split_ratio is not None else 50,
            panel_width=panel_width if panel_width is not None else 340,
