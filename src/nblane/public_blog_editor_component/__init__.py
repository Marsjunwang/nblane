...
def st_public_blog_editor(
    *,
    ...
    initial_markdown: str,
    key: str,
    library_tree: list[dict[str, Any]] | None = None,
    active_node_id: str | None = None,
    trash_nodes: list[dict[str, Any]] | None = None,
    library_capabilities: dict[str, Any] | None = None,
    active_route: str | None = None,
    category_options: list[dict[str, Any]] | None = None,
    active_category_path: list[str] | None = None,
    active_post_meta: dict[str, Any] | None = None,
    initial_blocks: list[dict[str, Any]] | None = None,
    ...
    ai_patches: list[dict[str, Any]] | None = None,
    ai_stream: dict[str, Any] | None = None,
    ...
    default = {
        ...
        "blocks_json": list(initial_blocks or []),
        "dirty": False,
        "layout_state": clean_layout_state,
        "selected_block": None,
        "insert_event": None,
        "library_tree": list(library_tree or []),
        "trash_nodes": list(trash_nodes or []),
    }
    result: Any = component_func(
        mode="shell",
        posts=list(posts or []),
        ...
        library_tree=list(library_tree or []),
        active_node_id=active_node_id or "",
        trash_nodes=list(trash_nodes or []),
        library_capabilities=dict(library_capabilities or {}),
        active_route=active_route or active_slug,
        category_options=list(category_options or []),
        active_category_path=list(active_category_path or []),
        initial_markdown=initial_markdown,
        initial_blocks=list(initial_blocks or []),
        ...
        ai_patch=dict(ai_patch or {}),
        ai_patches=list(ai_patches or []),
        ai_stream=dict(ai_stream or {}),
