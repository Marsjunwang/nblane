...
class TestResearchPaperReaderComponent(unittest.TestCase):
    def test_static_reader_uses_local_pdfjs_assets_and_known_actions(self) -> None:
        ...
        self.assertIn("page_models", html)
        self.assertIn("translation_units", html)
        self.assertIn("renderTranslationPage", html)
        self.assertIn("translationOverflowPolicy", html)
        self.assertIn("fitTranslationBlocks", html)
        self.assertIn("showTranslationUnitDock", html)
        self.assertIn("translationPageBaseSize", html)
        self.assertIn("scaleForTranslationPage", html)
        self.assertIn("normalizedRect", html)
        self.assertIn("pr-translation-page-shell", html)
        self.assertIn("pr-translation-layer", html)
        self.assertIn("pr-translation-fallback", html)
        self.assertIn("layoutOverlayUnitsForPage", html)
        self.assertIn("fallbackUnitsForPage", html)
        self.assertIn('if (text(obj.scope_type) !== "layout" || !hasRectGeometry(obj)) return false;', html)
        self.assertIn('if (text(obj.scope_type) === "layout") return obj.display_source === true ? text(obj.source_text) : "";', html)
        self.assertIn("buildAnchorIndex", html)
        self.assertIn("setActiveAnchor", html)
        self.assertIn('data-scope-type', html)
        self.assertIn('scope_strategy: "layout"', html)
        ...
        self.assertIn('"translation_layout": "overlay"', page_source)
        self.assertIn('"translation_overflow_policy": "fixed-expand"', page_source)
        ...
        self.assertNotIn('if (text(obj.scope_type) === "layout") return "";', html)
        self.assertNotIn("pr-translation-block.layout.empty", html)
        self.assertNotIn(".layout.missing", html)
        self.assertNotIn(".layout.failed", html)
        self.assertIn('scope_strategy: "layout"', html)
        self.assertIn("scope_refs: scopeType === \"layout\"", html)
