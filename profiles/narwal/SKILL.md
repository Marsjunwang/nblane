...
- **Name**: narwal
- **Domain**: {e.g. Robotics / ML / Embodied AI}
- **Journey**: Year {X} of 5
...
| Area | Status | Notes |
|------|--------|-------|
| {Skill Area 1} | learning | {brief context} |
| {Skill Area 2} | solid | {brief context} |
| {Skill Area 3} | locked | want to start in Q{X} |
...
- {Author et al., Year} — why it matters to me

**Open questions I obsess over**:
- {Question 1}

**My research taste** (what good work looks like to me):
- {e.g. I respect clean ablations over cherry-picked demos}
- {e.g. I care more about whether it works on real hardware than in sim}
